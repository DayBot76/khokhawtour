...
L.control.layers(baseLayer, overLayer).addTo(map3)
...
function onLocationFound(e) {
    ...
    gps.addTo(map3).bindPopup("คุณอยู่ที่นี่").openPopup();
}

map3.locate({ setView: true, maxZoom: 15 });
...
var mk1 = L.marker([18.4800222921417, 98.9591661818798]);
var mk2 = L.marker([18.5989016736122, 98.9669402576724]);
var mk3 = L.marker([18.5818036696129, 98.9961264974014]);
var mk4 = L.marker([18.5478942050036, 99.0527880262372]);
...
// var api3 = "https://9398-202-28-250-94.ap.ngrok.io/api/getdata3";

axios.get(url + "/api/getdata3").then(data => {
    ...
    data.data.data.forEach(x => {
        if (x.id = 10) {
            ...
            L.marker([x.lat, x.lng], { name: "marker1", icon: icon1 }).addTo(map3).bindPopup(`${x.name} <img src = "${x.picture} " width="300" > <br>
...
function findRoute(lat, lng) {
    L.Routing.control({
        waypoints: [
            ...
            L.latLng(18.4800222921417, 98.9591661818798),
            L.latLng(18.5989016736122, 98.9669402576724),
            L.latLng(18.5818036696129, 98.9961264974014),
            L.latLng(18.5478942050036, 99.0527880262372),
        ]
    }).addTo(map3);
}
// var mk1 = L.marker([]);
